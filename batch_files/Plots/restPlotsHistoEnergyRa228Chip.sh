...
#SBATCH -J  PlotIsotopeRa228Chip               # job name
#SBATCH -o  PlotIsotopeRa228Chip.o%j           # output and error file name (%j expands to jobID)
...
restPlots --c /home/zar30001/cristian/AGET_Sims/IAXOD0_AGET-REST/G4sims/restPlots/HistoEnergy_ArIso_Ra228Chip.rml