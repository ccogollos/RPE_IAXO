...
#SBATCH -J  PlotIsotopeK40Chip               # job name
#SBATCH -o  PlotIsotopeK40Chip.o%j           # output and error file name (%j expands to jobID)
...
restPlots --c /home/zar30001/cristian/AGET_Sims/IAXOD0_AGET-REST/G4sims/restPlots/HistoEnergy_ArIso_K40Chip.rml