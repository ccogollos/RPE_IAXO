...
#SBATCH -J  PlotIsotopeRa226Chip               # job name
#SBATCH -o  PlotIsotopeRa226Chip.o%j           # output and error file name (%j expands to jobID)
...
restPlots --c /home/zar30001/cristian/AGET_Sims/IAXOD0_AGET-REST/G4sims/restPlots/HistoEnergy_ArIso_Ra226Chip.rml