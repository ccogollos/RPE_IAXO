...
#SBATCH -J  SimK40FromChip_halfway               # job name
#SBATCH -o  SimK40FromChip_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 K40FromChip_halfway.rml