...
#SBATCH -J  SimRa228FromChip_outside               # job name
#SBATCH -o  SimRa228FromChip_outside.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra228FromChip_outside.rml