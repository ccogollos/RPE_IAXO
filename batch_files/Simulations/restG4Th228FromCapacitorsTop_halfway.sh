...
#SBATCH -J  SimTh228FromCapacitorsTop_halfway               # job name
#SBATCH -o  SimTh228FromCapacitorsTop_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th228FromCapacitorsTop_halfway.rml