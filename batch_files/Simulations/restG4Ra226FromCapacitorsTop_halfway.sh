...
#SBATCH -J  SimRa226FromCapacitorsTop_halfway               # job name
#SBATCH -o  SimRa226FromCapacitorsTop_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra226FromCapacitorsTop_halfway.rml