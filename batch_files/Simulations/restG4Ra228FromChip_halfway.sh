...
#SBATCH -J  SimRa228FromChip_halfway               # job name
#SBATCH -o  SimRa228FromChip_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra228FromChip_halfway.rml