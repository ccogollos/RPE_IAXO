...
#SBATCH -J  SimRa226FromChip_halfway               # job name
#SBATCH -o  SimRa226FromChip_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra226FromChip_halfway.rml