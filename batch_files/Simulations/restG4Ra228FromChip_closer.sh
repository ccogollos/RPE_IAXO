...
#SBATCH -J  SimRa228FromChip_closer               # job name
#SBATCH -o  SimRa228FromChip_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra228FromChip_closer.rml