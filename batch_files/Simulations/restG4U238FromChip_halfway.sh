...
#SBATCH -J  SimU238FromChip_halfway               # job name
#SBATCH -o  SimU238FromChip_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 U238FromChip_halfway.rml