...
#SBATCH -J  SimRa226FromCapacitorsBottom_closer               # job name
#SBATCH -o  SimRa226FromCapacitorsBottom_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra226FromCapacitorsBottom_closer.rml