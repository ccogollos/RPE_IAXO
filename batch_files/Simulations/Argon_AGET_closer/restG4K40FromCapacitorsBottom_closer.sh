...
#SBATCH -J  SimK40FromCapacitorsBottom_closer               # job name
#SBATCH -o  SimK40FromCapacitorsBottom_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 K40FromCapacitorsBottom_closer.rml