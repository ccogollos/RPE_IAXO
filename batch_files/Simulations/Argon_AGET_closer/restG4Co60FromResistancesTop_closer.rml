...
#SBATCH -J  SimCo60FromResistancesTop_closer               # job name
#SBATCH -o  SimCo60FromResistancesTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Co60FromResistancesTop_closer.rml