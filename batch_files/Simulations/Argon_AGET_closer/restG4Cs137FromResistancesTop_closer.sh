...
#SBATCH -J  SimCs137FromResistancesTop_closer               # job name
#SBATCH -o  SimCs137FromResistancesTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Cs137FromResistancesTop_closer.rml