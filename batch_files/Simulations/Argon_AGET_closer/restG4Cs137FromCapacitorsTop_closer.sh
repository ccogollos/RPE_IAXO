...
#SBATCH -J  SimCs137FromCapacitorsTop_closer               # job name
#SBATCH -o  SimCs137FromCapacitorsTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Cs137FromCapacitorsTop_closer.rml