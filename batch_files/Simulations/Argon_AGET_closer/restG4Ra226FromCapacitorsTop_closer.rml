...
#SBATCH -J  SimRa226FromCapacitorsTop_closer               # job name
#SBATCH -o  SimRa226FromCapacitorsTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra226FromCapacitorsTop_closer.rml