...
#SBATCH -J  SimTh232FromCapacitorsBottom_closer               # job name
#SBATCH -o  SimTh232FromCapacitorsBottom_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th232FromCapacitorsBottom_closer.rml