...
#SBATCH -J  SimTh232FromCapacitorsTop_closer               # job name
#SBATCH -o  SimTh232FromCapacitorsTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th232FromCapacitorsTop_closer.rml