...
#SBATCH -J  SimCo60FromCapacitorsTop_closer               # job name
#SBATCH -o  SimCo60FromCapacitorsTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Co60FromCapacitorsTop_closer.rml