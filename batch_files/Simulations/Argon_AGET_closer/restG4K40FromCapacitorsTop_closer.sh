...
#SBATCH -J  SimK40FromCapacitorsTop_closer               # job name
#SBATCH -o  SimK40FromCapacitorsTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 K40FromCapacitorsTop_closer.rml