...
#SBATCH -J  SimU238FromCapacitorsBottom_closer               # job name
#SBATCH -o  SimU238FromCapacitorsBottom_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 U238FromCapacitorsBottom_closer.rml