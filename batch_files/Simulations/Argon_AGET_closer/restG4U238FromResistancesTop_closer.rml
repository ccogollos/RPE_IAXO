...
#SBATCH -J  SimU238FromResistancesTop_closer               # job name
#SBATCH -o  SimU238FromResistancesTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 U238FromResistancesTop_closer.rml