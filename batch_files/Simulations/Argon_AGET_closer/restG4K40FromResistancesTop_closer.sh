...
#SBATCH -J  SimK40FromResistancesTop_closer               # job name
#SBATCH -o  SimK40FromResistancesTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 K40FromResistancesTop_closer.rml