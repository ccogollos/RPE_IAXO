...
#SBATCH -J  SimU238FromCapacitorsTop_closer               # job name
#SBATCH -o  SimU238FromCapacitorsTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 U238FromCapacitorsTop_closer.rml