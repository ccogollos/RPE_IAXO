...
#SBATCH -J  SimTh232FromResistancesTop_closer               # job name
#SBATCH -o  SimTh232FromResistancesTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th232FromResistancesTop_closer.rml