...
#SBATCH -J  SimTh228FromResistancesTop_closer               # job name
#SBATCH -o  SimTh228FromResistancesTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th228FromResistancesTop_closer.rml