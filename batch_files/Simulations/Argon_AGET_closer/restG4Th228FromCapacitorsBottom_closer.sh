...
#SBATCH -J  SimTh228FromCapacitorsBottom_closer               # job name
#SBATCH -o  SimTh228FromCapacitorsBottom_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th228FromCapacitorsBottom_closer.rml