...
#SBATCH -J  SimRa226FromResistancesTop_closer               # job name
#SBATCH -o  SimRa226FromResistancesTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Ra226FromResistancesTop_closer.rml