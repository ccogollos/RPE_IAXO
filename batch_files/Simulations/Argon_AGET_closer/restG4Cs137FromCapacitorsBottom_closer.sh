...
#SBATCH -J  SimCs137FromCapacitorsBottom_closer               # job name
#SBATCH -o  SimCs137FromCapacitorsBottom_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Cs137FromCapacitorsBottom_closer.rml