...
#SBATCH -J  SimCo60FromCapacitorsBottom_closer               # job name
#SBATCH -o  SimCo60FromCapacitorsBottom_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Co60FromCapacitorsBottom_closer.rml