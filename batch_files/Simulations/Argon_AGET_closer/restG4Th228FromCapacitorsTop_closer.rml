...
#SBATCH -J  SimTh228FromCapacitorsTop_closer               # job name
#SBATCH -o  SimTh228FromCapacitorsTop_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 Th228FromCapacitorsTop_closer.rml