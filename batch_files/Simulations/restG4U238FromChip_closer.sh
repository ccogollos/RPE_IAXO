...
#SBATCH -J  SimU238FromChip_closer               # job name
#SBATCH -o  SimU238FromChip_closer.o%j           # output and error file name (%j expands to jobID)
...
restG4 U238FromChip_closer.rml