...
#SBATCH -J  SimU238FromCapacitorsBottom_halfway               # job name
#SBATCH -o  SimU238FromCapacitorsBottom_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 U238FromCapacitorsBottom_babyIAXO.rml