...
#SBATCH -J  SimK40FromCapacitorsTop_halfway               # job name
#SBATCH -o  SimK40FromCapacitorsTop_halfway.o%j           # output and error file name (%j expands to jobID)
...
restG4 K40FromCapacitorsTop_halfway.rml