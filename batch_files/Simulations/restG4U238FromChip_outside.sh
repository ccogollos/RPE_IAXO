...
#SBATCH -J  SimU238FromChip_outside               # job name
#SBATCH -o  SimU238FromChip_outside.o%j           # output and error file name (%j expands to jobID)
...
restG4 U238FromChip_outside.rml